...
import 'package:videoplayerdemo/app/custom/widgets/custom_options_dialog.dart';
...
class CustomControls extends StatefulWidget {
  ...
  final Function(double? details)? onProgressChange;
...
class _CustomControlsState extends State<CustomControls>
            ...
            children: [
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  _buildBottomBar(backgroundColor, iconColor, barHeight, widget.onProgressChange),
                ],
              ),
            ],
          ),
      ...
      onTap: () async {
        ...
        if (chewieController.optionsBuilder != null) {
          ...
          await showCupertinoModalPopup<OptionItem>(
            ...
            builder: (context) => CustomOptionsDialog(
              options: options,
              cancelButtonText:
  ...
  Widget _buildBottomBar(
    ...
    Color iconColor,
    double barHeight,Function(double? details)?  onProgressChange
  ) {
    return SafeArea(
                ...
                child: chewieController.isLive
                    ...
                    : Row(
                        children: <Widget>[
                          ...
                          _buildProgressBar(onProgressChange),
  ...
  Widget _buildProgressBar(Function(double? details)?  onProgressChange) {
    return Expanded(
      child: Padding(
        padding: const EdgeInsets.only(right: 12.0),
        child: CustomVideoProgressBar(
          ...
          onDragEnd: (double? details) {
            setState(() {
              _dragging = false;
            });

            onProgressChange!(details)?.call();
            _startHideTimer();
          },
